package com.example.ul.pay.util;

import com.example.ul.pay.SignUtils;
...
public class OrderInfoUtil2_0 {
	 ...
	 * @return
	 */
	public static Map<String, String> buildAuthInfoMap(String pid, String app_id, String target_id, boolean rsa2, String price) {
