...
public class ShowPictureAdapter extends RecyclerView.Adapter<ShowPictureAdapter.ViewHolder>{
    ...
    public interface  ItemClickListener{
         ...
         * @return:
         */
        void onItemClick(ArrayList<String> data, int position);
    }

    private ItemClickListener itemClickListener;

    public ShowPictureAdapter(Context context, ItemClickListener itemClickListener, ArrayList<String> data) {
